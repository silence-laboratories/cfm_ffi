...
use crate::sl_oblivious::label::Label;
...
/// LABEL for Authenticated Beaver Triples
pub const AUTH_BEAVER_TRIPLES_LABEL: Label = Label::new(VERSION, 14);

/// LABEL to commit rho value
pub const COMMIT_RHO_LABEL: Label = Label::new(VERSION, 15);

/// LABEL for RO for rho value
pub const RO_RHO_LABEL: Label = Label::new(VERSION, 16);
